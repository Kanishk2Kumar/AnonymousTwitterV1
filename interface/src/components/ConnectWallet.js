...
function ConnectWallet() {
  ...
  return (
    <div className='min-h-screen flex flex-col bg-blue-950'>
      <header className='bg-blue-900 shadow-md px-6'>
        <div className='container mx-auto px-4 py-4 flex justify-between items-center'>
          ...
          <button
            ...
            className='bg-blue-600 text-white font-medium py-2 px-4 rounded-md hover:bg-blue-500 transition duration-150 ease-in-out'
          >
            Connect MetaMask
          </button>
        </div>
      </header>
      <main className='flex-grow container my-[-40px] mx-auto px-10 py-16 flex items-center justify-between'>
        <div className='max-w-xl'>
          <h2 className='text-7xl font-bold text-white mb-4'>
            Welcome to Anonymous Twitter
          </h2>
          ...
          <button
            onClick={connectWallet}
            className='bg-blue-600 text-white font-medium py-3 px-6 rounded-md hover:bg-blue-500 transition duration-150 ease-in-out text-lg'
          >
            Get Started
          </button>
        </div>
